export let jobs = [
  {
    ...
    "type": "Full-Time",
    "description": "We are seeking a talented Front-End Developer to join our team in Bengaluru, KA. The ideal candidate will have strong skills in HTML, CSS, and JavaScript, with experience working with modern JavaScript frameworks such as React or Angular.",
  ...
  },
  {
    ...
    "description": "Join our team as a Front-End Developer in sunny New Delhi, DL. We are looking for a motivated individual with a passion for crafting beautiful and responsive web applications. Experience with UI/UX design principles and a strong attention to detail are highly desirable.",
    "salary": "12L - 14L",
    "company": {
  ...
  },
  {
    ...
    "type": "Full-Time",
    "location": "Noida, NCR",
    "description": "Are you passionate about front-end development? Join our team in vibrant Noida, NCR, and work on exciting projects that make a difference. We offer competitive compensation and a collaborative work environment where your ideas are valued.",
    "salary": "11L - 17L",
    "company": {
      "name": "Dolor Cloud",
  ...
  },
  {
    ...
    "type": "Part-Time",
    "description": "Join our team as a Part-Time Front-End Developer in beautiful Gurgaon, NCR. We are looking for a self-motivated individual with a passion for creating engaging user experiences. This position offers flexible hours and the opportunity to work remotely.",
  ...
  },
  {
    ...
    "type": "Full-Time",
    "description": "Exciting opportunity for a Full-Time Front-End Developer in bustling New Delhi, DL. We are seeking a talented individual with a passion for building elegant and scalable web applications. Join our team and make an impact!",
    "location": "New Delhi, DL",
    "salary": "7L - 10L",
    "company": {
  ...
  },
  {
    ...
    "type": "Full-Time",
    "description": "Join our team as a Front-End Developer in beautiful Chennai, TN. We are looking for a skilled and enthusiastic individual to help us create innovative web solutions. Competitive salary and great benefits package available.",
    "location": "Chennai, TN",
    "salary": "4L - 6L",
    "company": {
